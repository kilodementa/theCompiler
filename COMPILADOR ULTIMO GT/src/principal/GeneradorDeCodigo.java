...
public class GeneradorDeCodigo {
    ...
    public void cargarInt(int numero){
        memoria[topeMemoria] = (byte) (numero & 0xFF); // menos significativo
        topeMemoria++;
        memoria[topeMemoria] = (byte) ((numero >> 8) & 0xFF);
        topeMemoria++;
        memoria[topeMemoria] = (byte) ((numero >> 16) & 0xFF);
        topeMemoria++;
        memoria[topeMemoria] = (byte) ((numero >> 24) & 0xFF); // mas significativo
        topeMemoria++;
    }
    ...
    public int descargarIntDe(int posicion){
        int numero;
        numero = (int) memoria[posicion];
        numero += ((int) memoria[posicion+1]) * 0x100;
        numero += ((int) memoria[posicion+2]) * 0x10000;
        numero += ((int) memoria[posicion+3]) * 0x1000000;
